...
const PreviewMetadata = ({ description, taxId, isDark }: { description: string; taxId: string; isDark: boolean }) => (
  ...
  return (
    ...
    >
      {onStorefrontThemeChange && (
        <Button
          variant="tonal"
          onClick={() => onStorefrontThemeChange(createRandomStorefrontTheme({ fontFamily: storefrontTheme.fontFamily }))}
          style={{
            position: 'absolute',
            top: '28px',
            left: '28px', /* CHANGED FROM right: '28px' */
            borderRadius: '50%',
            width: '44px',
            height: '44px',
            minWidth: '44px',
