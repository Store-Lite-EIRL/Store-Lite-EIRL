...
import { Switch, Select, SelectOption } from './inputs';

export function ThemeSettings() {
  const { theme, colorScheme, setTheme, setColorScheme } = useTheme();

  return (
    <div className="theme-settings-panel" style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      
      {/* SECCIÓN DE TEMA */}
      <section className="section" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
        <h3 className="theme-settings-header" style={{ fontSize: '14px', fontWeight: 600, color: 'var(--md-sys-color-on-surface-variant)', margin: 0 }}>
          Modo y Apariencia
        </h3>
          ...
          <div style={{ 
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              ...
              <div style={{ paddingRight: '12px' }}>
                <p style={{ margin: 0, fontWeight: 600, fontSize: '14px', color: 'var(--md-sys-color-on-surface)' }}>
                  Tema automático
                </p>
      ...
      <section className="section" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
        ...
        <div style={{
          ...
          <Select 
            value={colorScheme}
            onChange={(e: Event & { target?: { value?: string }; currentTarget?: { value?: string } }) => {
