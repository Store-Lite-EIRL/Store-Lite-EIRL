...
export const PERU_LOCATIONS: Department[] = [
  {
    ...
    provinces: [
      ...
      { id: '0105', name: 'LUYA', districts: [{ id: '010501', name: 'LAMUD' }] },
      {
        ...
        districts: [{ id: '010601', name: 'SAN NICOLAS' }],
      },
  ...
  },
  {
    ...
    provinces: [
      ...
      { id: '0206', name: 'CARHUAZ', districts: [{ id: '020601', name: 'CARHUAZ' }] },
      {
        ...
        districts: [{ id: '020701', name: 'SAN LUIS' }],
      },
    ...
    provinces: [
      {
        ...
        districts: [
          ...
          { id: '040122', name: 'YANAHUARA' },
          { id: '040125', name: 'JOSE LUIS BUSTAMANTE Y RIVERO' },
        ],
      },
  ...
  },
  {
    ...
    provinces: [
      ...
      { id: '0609', name: 'SAN IGNACIO', districts: [{ id: '060901', name: 'SAN IGNACIO' }] },
      {
        id: '0610',
        name: 'SAN MARCOS',
        districts: [{ id: '061101', name: 'SAN PEDRO DE CHANCAY' }],
      },
    ...
    provinces: [
      {
        ...
        districts: [
          ...
          { id: '070103', name: 'CARMEN DE LA LEGUA' },
    ...
    provinces: [
      {
        ...
        districts: [
          ...
          { id: '080105', name: 'SAN SEBASTIAN' },
          { id: '080104', name: 'SAN JERONIMO' },
        ],
      },
  ...
  },
  {
    ...
    provinces: [
      ...
      { id: '1310', name: 'SANCHEZ CARRION', districts: [{ id: '131001', name: 'HUAMACHUCO' }] },
      {
        ...
        districts: [{ id: '131101', name: 'SANTIAGO DE CHUCO' }],
      },
    ...
    provinces: [
      {
        ...
        districts: [
          ...
          { id: '140105', name: 'JOSE LEONARDO ORTIZ' },
          { id: '140112', name: 'VICTORIA' },
        ],
      },
    ...
    provinces: [
      {
        ...
        districts: [
          ...
          { id: '150129', name: 'SAN ISIDRO' },
          { id: '150130', name: 'SAN JUAN DE LURIGANCHO' },
          { id: '150138', name: 'SANTIAGO DE SURCO' },
        ],
      },
  ...
  },
  {
    ...
    provinces: [
      ...
      { id: '1603', name: 'LORETO', districts: [{ id: '160301', name: 'NAUTA' }] },
      {
        ...
        districts: [{ id: '160401', name: 'RAMON CASTILLA' }],
      },
  ...
  },
  {
    ...
    provinces: [
      { id: '1901', name: 'PASCO', districts: [{ id: '190101', name: 'CHAUPIMARCA' }] },
      {
        ...
        districts: [{ id: '190201', name: 'YANAHUANCA' }],
      },
  ...
  },
  {
    ...
    provinces: [
      { id: '2401', name: 'TUMBES', districts: [{ id: '240101', name: 'TUMBES' }] },
      {
        ...
        districts: [{ id: '240201', name: 'ZORRITOS' }],
      },
