  ...
  return (
    <div className="flex flex-col gap-6 w-full">
      <div className="flex items-center gap-2">
        <span className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">Métodos de Pago</span>
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col items-center gap-1">
                ...
                {isActive && (
                  <span className="text-[8px] font-black uppercase tracking-[0.2em] text-[#135bec]">Seleccionado</span>
                )}
              </div>
            </button>
          );
