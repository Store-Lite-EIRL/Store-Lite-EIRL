...
export default function AuthPage() {
  ...
  // Clean stale business data from previous sessions (defense layer C, R8).
  useEffect(() => {
  ...
  return (
    <div className={styles.authShell}>
      {/* Viewport background decor: glow orbs + dot grid (aria-hidden, R7) */}
      ...
      {/* Floating particles (aria-hidden, R7) */}
      ...
      <section className={styles.formPanel} aria-labelledby="auth-title">
        <div className={styles.formInner}>
          ...
          <div className={styles.authButtons}>
            ...
            >
              {googleLoading ? (
                ...
                <>
                  ...
                  <span className={styles.providerLabel}>Continuar con Google</span>
                </>
              )}
            </button>
            ...
            >
              {facebookLoading ? (
                ...
                <>
                  ...
                  <span className={styles.providerLabel}>Continuar con Facebook</span>
                </>
              )}
            </button>
            ...
            <button
              type="button"
              className={`${styles.authButton} ${styles.phoneButton}`}
              disabled
